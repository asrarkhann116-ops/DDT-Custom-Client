...
window.VencordNative = {
    ...
    updater: {
        getRepo: async () => ({ ok: true, value: "https://github.com/asrarkhann116-ops/DDT-Custom-Client" }),
    ...
    settings: {
        ...
        getSettingsDir: async () => Promise.reject("settings:getSettingsDir is not supported on web"),
    },
