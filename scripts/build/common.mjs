...
export const gitHash = process.env.VENCORD_HASH || "dev-build";

export const banner = {
    js: `
// DDT Custom Client ${gitHash}
...
export const gitRemotePlugin = {
    ...
    setup: build => {
        ...
        build.onLoad({ filter, namespace: "git-remote" }, async () => {
            let remote = process.env.VENCORD_REMOTE || "asrarkhann116-ops/DDT-Custom-Client";
    ...
    setup(build) {
        build.onResolve({ filter: /^@/ }, args => {
            const aliasMap = {
                ...
                "@webpack/wreq.d": "./src/webpack/wreq.d",
...
export const commonOpts = {
    ...
    banner,
    plugins: [pathAliasPlugin, fileUrlPlugin, gitHashPlugin, gitRemotePlugin, stylePlugin],
