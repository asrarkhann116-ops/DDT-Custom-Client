...
// DDT Custom Client - ASCII Art Logo (Renderer Console)
console.log(`
%c ██████╗ ██████╗ ████████╗
%c ██╔══██╗██╔══██╗╚══██╔══╝
%c ██║  ██║██║  ██║   ██║   
...
%c 288+ Plugins | Zero Telemetry | github.com/asrarkhann116-ops
`, 
    ...
    if (IS_DEV) {
        ...
        if (pendingPatches.length)
            PMLogger.warn(
                ...
                "You are seeing this warning because this is a Development build of DDT.",
