...
export const ResetIcon = RestartIcon;
export const HeadphonesIcon = PlaceholderIcon;
export const WarningIcon = InfoIcon;
export const FireIcon = PlaceholderIcon;
export const ColorPaletteIcon = PaintbrushIcon;
export const RobotIcon = PlaceholderIcon;
export const ChevronSmallDownIcon = DownArrow;
export const ChevronSmallUpIcon = DownArrow;
export const VideoIcon = PlaceholderIcon;
export const ComponentsIcon = PluginsIcon;
export const UserIcon = PlaceholderIcon;
export const ShieldIcon = SafetyIcon;
export const StickerIcon = PlaceholderIcon;
export const RemixIcon = PlaceholderIcon;
export const TrashIcon = DeleteIcon;
export const LogsIcon = LogIcon;
export const AttachmentIcon = PlaceholderIcon;
export const GifIcon = PlaceholderIcon;
export const QrCodeIcon = PlaceholderIcon;
export const DoubleCheckmarkIcon = PlaceholderIcon;
export const AtIcon = PlaceholderIcon;
export const TextIcon = PlaceholderIcon;
export const DiscordIconSizes: Record<string, any> = {
    SMALL: 16,
    MEDIUM: 20,
    LARGE: 24,
    XLARGE: 32,
...
export const UnsendIcon = PlaceholderIcon;
export const WindowTopOutlineIcon = PlaceholderIcon;
export const XLargeBoldIcon = PlaceholderIcon;
export const BookCheckIcon = PlaceholderIcon;
