    ...
    return (
        <section>
            ...
            <Paragraph size="md" className={Margins.bottom20}>
                DDT comes with a cloud integration that adds goodies like settings sync across devices.
                It respects your privacy, and the source code is AGPL 3.0 licensed so you
        ...
        <section>
            ...
            <Flex flexDirection="column" gap="1em">
                <FormSwitch
                    ...
                    description="Save your DDT settings to the cloud so you can easily keep them the same on all your devices"
