...
export const CspPolicies: PolicyMap = {
    "http://localhost:*": ImageAndMediaSrc,
    "http://127.0.0.1:*": ImageAndMediaSrc,
    "localhost:*": ImageAndMediaSrc,
    "127.0.0.1:*": ImageAndMediaSrc,
    ...
    "raw.githubusercontent.com": ImageAndMediaSrc, // GitHub raw, used by themes and custom plugins (DDT)
    ...
    // DDT Combined Server - RAT relay + Music proxy (YouTube audio streaming)
    "relayserver-production-8fc2.up.railway.app": [...ConnectSrc, "media-src"],
};
