...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the DDT settings section",
        options: [
            ...
            { label: "At the very bottom", value: "bottom", default: true },
        ] as { label: string; value: SettingsLocation; default?: boolean; }[]
    },
    includeVencordInfoWhenCopying: {
        type: OptionType.BOOLEAN,
        description: "Also copy DDT info (DDT, Electron, Chromium) when clicking the version info in the bottom left area of the Settings page",
        default: true
    }
});
...
export default definePlugin({
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        if (layout.some(s => s?.key === "ddt_section")) return layout;

        const { buildEntry } = this;

        const ddtEntries: SettingsLayoutNode[] = [
            buildEntry({
                key: "ddt_main",
                title: "Developer Tools",
                panelTitle: "Discord Developer Tools",
            ...
            buildEntry({
                key: "ddt_cloud",
                title: "Cloud",
                panelTitle: "DDT Cloud",
                Component: CloudTab,
                Icon: CloudIcon
            }),
            buildEntry({
                key: "ddt_backup_restore",
                title: "Backup & Restore",
                Component: BackupAndRestoreTab,
                Icon: BackupRestoreIcon
            }),
            !IS_STANDALONE && PatchHelperTab && buildEntry({
                key: "ddt_patch_helper",
                title: "Patch Helper",
            ...
            ...this.customSections.map((func, i) => {
                ...
                return buildEntry({
                    key: `ddt_deprecated_custom_${section}`,
                    title: label,
                    Component: element,
        ...
        const ddtSection: SettingsLayoutNode = {
            key: "ddt_section",
            type: LayoutTypes.SECTION,
            useTitle: () => "Discord Developer Tools",
            buildLayout: () => ddtEntries
        };
        ...
        layout.splice(idx, 0, ddtSection);
    ...
    getInfoRows() {
        ...
        const rows = [`DDT ${gitHash}${additionalInfo}`];
