...
import DDTToolboxPlugin from "@plugins/ddtToolbox";
...
const settings = definePluginSettings({
    ...
    location: {
        ...
        get hidden() {
            return !isPluginEnabled(DDTToolboxPlugin.name);
        }
    }
});
...
function GameActivityToggleButton(props: { nameplate?: any; }) {
    ...
    if (location !== "PANEL" && isPluginEnabled(DDTToolboxPlugin.name)) return null;
