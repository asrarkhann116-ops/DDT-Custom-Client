...
const DDTBrandLogo = () => (
    <div
        className="ddt-sidebar-brand"
        title="DDT Custom Client"
        onClick={() => {
    ...
    >
        <img src={DDT_LOGO_DATA_URL} alt="DDT" className="ddt-sidebar-logo-img" />
        <span className="ddt-sidebar-brand-text">DDT</span>
    </div>
);
