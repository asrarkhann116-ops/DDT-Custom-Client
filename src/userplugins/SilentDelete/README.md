...
```
3. Navigate to the `src/DDTplugins` folder in the cloned DDT repository.

3. Download `silentDelete.tsx` from the repository and move it to the `DDTplugins` folder.
