            ...
            <div style={{ marginTop: "15px", display: "flex", gap: "10px", flexWrap: "wrap" }}>
                ...
                <Button
                    ...
                    onClick={() => {
                        ...
                        Toasts.show({ message: "Stats logged to console", type: Toasts.Type.MESSAGE, id: "ddt-stats" });
                    }}
                >
                    View Stats
                </Button>
            ...
            <div style={{ marginTop: "20px", display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: "10px" }}>
                <Button
                    onClick={() => {
                        ...
                        Toasts.show({ message: "Help logged to console", type: Toasts.Type.MESSAGE, id: "ddt-help" });
                    }}
                >
                    📖 Show Help
                </Button>
                ...
                <Button
                    onClick={() => {
                        (window as any).APIInspector?.stats();
                        (window as any).EventLogger?.stats();
                        Toasts.show({ message: "Stats in console", type: Toasts.Type.MESSAGE, id: "ddt-stats" });
                    }}
                >
                    📊 View All Stats
                </Button>
