...
import { Devs, GUILD_ID, SUPPORT_CHANNEL_ID, SUPPORT_CHANNEL_IDS, VC_SUPPORT_CHANNEL_IDS } from "@utils/constants";
...
migratePluginToSettings(true, "DDTHelper", "NoBulletPoints", "noBulletPoints");
migratePluginToSettings(true, "DDTHelper", "NoModalAnimation", "noModalAnimation");
migratePluginToSettings(true, "DDTHelper", "GuildTagSettings", "disableAdoptTagPrompt");
        ...
        async CHANNEL_SELECT({ channelId }) {
            ...
            if (VC_SUPPORT_CHANNEL_IDS.includes(channelId) && !clicked) {
                return Alerts.show({
                    ...
                    body: "Before asking for help. Check updates and if this issue is actually caused by DDT!",
                    confirmText: "DDT Support",
                    onConfirm() {
