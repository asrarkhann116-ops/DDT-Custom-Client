...
export const actions: ButtonAction[] = [
    { id: "openDDTSettings", label: "Open DDT tab", callback: async () => await SettingsRouter.openUserSettings("DDT_main_panel"), registrar: "DDT" },
    { id: "openPluginSettings", label: "Open Plugin tab", callback: () => SettingsRouter.openUserSettings("DDT_plugins_panel"), registrar: "DDT" },
    { id: "openThemesSettings", label: "Open Themes tab", callback: () => SettingsRouter.openUserSettings("DDT_themes_panel"), registrar: "DDT" },
    { id: "openUpdaterSettings", label: "Open Updater tab", callback: () => SettingsRouter.openUserSettings("DDT_updater_panel"), registrar: "DDT" },
    { id: "openDDTCloudSettings", label: "Open Cloud tab", callback: () => SettingsRouter.openUserSettings("DDT_cloud_panel"), registrar: "DDT" },
    { id: "openBackupSettings", label: "Open Backup & Restore tab", callback: () => SettingsRouter.openUserSettings("DDT_backup_restore_panel"), registrar: "DDT" },
    { id: "restartClient", label: "Restart Client", callback: () => relaunch(), registrar: "DDT" },
    { id: "openQuickCSSFile", label: "Open Quick CSS File", callback: () => VencordNative.quickCss.openEditor(), registrar: "DDT" },
    { id: "openSettingsFolder", label: "Open Settings Folder", callback: async () => showItemInFolder(await (VencordNative.settings as any).getSettingsDir()), registrar: "DDT" },
    { id: "openInGithub", label: "Open in Github", callback: async () => VencordNative.native.openExternal(await getRepo()), registrar: "DDT" },
        ...
        id: "checkForUpdates", label: "Check for Updates", callback: async () => {
            ...
            if (isOutdated) {
                setTimeout(() => showNotification({
                    ...
                    noPersist: true,
                    onClick() {
                        SettingsRouter.openUserSettings("DDT_updater_panel");
                    }
                }), 10_000);
            } else {
                Toasts.show({
