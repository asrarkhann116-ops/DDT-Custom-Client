...
import { getLyrics, lyricFetchers, providers, updateLyrics } from "@userplugins/musicControls/spotify/lyrics/api";
import { SpotifyStore, type Track } from "@userplugins/musicControls/spotify/SpotifyStore";
