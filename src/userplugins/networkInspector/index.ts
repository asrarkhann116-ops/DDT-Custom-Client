        ...
        constructor(url: string | URL, protocols?: string | string[]) {
            ...
            this.send = function (data: string | ArrayBufferLike | Blob | ArrayBufferView) {
                ...
                if (hasSharedArrayBuffer && data instanceof SharedArrayBuffer) {
                    ...
                    if (hasSharedArrayBuffer && view.buffer instanceof SharedArrayBuffer) {
                        const regularBuffer = new ArrayBuffer(view.byteLength);
                        new Uint8Array(regularBuffer).set(new Uint8Array(view.buffer, view.byteOffset, view.byteLength));
                        bodyData = regularBuffer;
                    } else {
