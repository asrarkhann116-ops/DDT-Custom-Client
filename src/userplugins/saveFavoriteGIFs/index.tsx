...
import DDTToolbox from "@plugins/ddtToolbox";
...
const settings = definePluginSettings({
    showToolboxButton: {
        description: "Show 'Save Favorite GIFs' button in DDT Toolbox (Requires Reload)",
        type: OptionType.BOOLEAN,
        default: true,
        restartNeeded: true,
        get hidden() {
            return !isPluginEnabled(DDTToolbox.name);
        }
    }
});
