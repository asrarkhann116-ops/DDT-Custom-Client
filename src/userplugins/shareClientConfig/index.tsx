...
const FILE_NAME = "DDT-config.json";
const FORMAT = "DDT-shared-config";
...
async function applySharedConfig(attachment: MessageAttachment): Promise<void> {
    try {
        ...
        showToast("Configuration applied. Restart DDT to finish applying the changes.", Toasts.Type.SUCCESS);
    } catch (error) {
...
export default definePlugin({
    ...
    description: "Share your DDT configuration in chat without API keys or other sensitive values.",
    ...
    settingsAboutComponent() {
        return (
            <>
                ...
                <Paragraph>
                    Share your DDT and plugin settings through a chat attachment.
                ...
                <Paragraph>
                    ...
                    {" "}<strong>Apply DDT configuration</strong> in the message action bar.
                    Confirm with <strong>Apply</strong>, wait for the success message, then restart DDT.
                ...
                <Paragraph>
                    ...
                    You can save a backup from the DDT settings before applying a configuration.
                </Paragraph>
    ...
    commands: [{
        name: "share-config",
        description: "Prepare your DDT configuration for sharing without sensitive data.",
