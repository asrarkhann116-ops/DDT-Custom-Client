...
import { Native, useRender } from "@userplugins/songSpotlight.desktop/service";
import {
    CardClasses,
    ExplicitTag,
    ImageBrokenIcon,
...
import AudioPlayer from "@userplugins/songSpotlight.desktop/ui/components/AudioPlayer";
