...
export function BrowserSettings() {
    ...
    return <>
        ...
        {security ? <>
            ...
            {security.sandbox === false ? <Paragraph>The current DDT preload requires an unsandboxed renderer. Minimum privilege cannot enable its sandbox without replacing the loader.</Paragraph> : null}
        </> : null}
    </>;
}
