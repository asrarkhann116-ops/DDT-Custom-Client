...
const SETTINGS_ENTRY_KEY = "DDT_discord_hardened";
...
export const settings = definePluginSettings({
    ...
    minimumPrivilege: {
        type: OptionType.BOOLEAN,
        description: "Restrict plugin IPC to Discord main frames and enforce available Electron protections at startup. The main renderer sandbox remains limited by the DDT loader.",
        default: true,
        restartNeeded: true,
        target: "DESKTOP",
    },
...
export default definePlugin({
    ...
    description: "Ports WebCord's compatible privacy and security controls to DDT.",
