...
export const DISCORD_SETTINGS_ROUTES: SettingsRoute[] = [
    ...
    { route: "DDT_main", label: "DDT", keywords: ["vencord"] },
    { route: "DDT_plugins", label: "DDT Plugins", keywords: ["plugins"] },
    { route: "DDT_themes", label: "DDT Themes", keywords: ["themes", "css"] },
    { route: "DDT_updater", label: "DDT Updater", keywords: ["update"] },
    { route: "DDT_changelog", label: "DDT Changelog", keywords: ["changelog", "news"] }
];
...
const ROUTE_ALIASES = new Map<string, string[]>([
    ...
    ["DDT_main", ["DDT_main_panel"]],
    ["DDT_plugins", ["DDT_plugins_panel"]],
    ["DDT_themes", ["DDT_themes_panel"]],
    ["DDT_updater", ["DDT_updater_panel"]],
    ["DDT_changelog", ["DDT_changelog_panel"]]
]);
