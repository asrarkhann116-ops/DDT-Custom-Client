...
import { settings as musicControlsSettings } from "@userplugins/musicControls/settings";
import { SpotifyStore } from "@userplugins/musicControls/spotify/SpotifyStore";
...
const cl = classNameFactory("vc-DDT-dynamic-island-");
const NOTIFICATION_DURATION = 5000;
const RUNTIME_KEY = Symbol.for("DDTDynamicIsland.runtime");
        ...
        <div className={cl("root", `color-${islandColor}`, {
            ...
            >
                ...
                <div key={notification?.id ?? primary ?? "idle"} className={cl("summary-copy")}>
                    <strong>{notification?.title ?? (primaryStream ? "You are sharing your screen" : primaryTrack?.name ?? (primaryChannelId ? "Discord call" : "DDT Dynamic Island"))}</strong>
