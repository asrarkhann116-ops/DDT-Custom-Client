                ...
                <div className={cl("toolbar")}>
                    ...
                    <details className={cl("management")}>
                        ...
                        <div className={cl("backup-actions")}>
                            ...
                            <Button size="small" variant="secondary" disabled={busy || pending || records.length === 0} onClick={() => exportLogRecords(records, "ddt-message-logger-visible")}>Export loaded</Button>
