...
export function noticeManualCaptcha(context: string) {
    ...
    console.log(`[DDT Quest] Discord is asking for a captcha (${context}). Solve it in Discord and this will carry on. No captcha service key is set, so nothing is being attempted automatically.`);
}
