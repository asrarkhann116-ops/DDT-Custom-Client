...
export default definePluginSettings({
    acceptQuestsAutomatically: {
        ...
        description: "⚠️ AUTO-ACCEPT: Automatically accept ALL available Discord quests. Enable only if you want quests to start automatically.",
        default: false,
    },
    autoClaimRewards: {
        type: OptionType.BOOLEAN,
        description: "⚠️ AUTO-CLAIM: Automatically claim rewards once quests complete. Disable for manual control.",
        default: false,
    },
    preferredRewardType: {
    ...
    showQuestLauncher: {
        type: OptionType.BOOLEAN,
        description: "Show the DDT Quest button. Unlike the quests button above, this one is drawn by the plugin, so a Discord update cannot take it away.",
        default: true,
    },
    questLauncherPosition: {
        type: OptionType.SELECT,
        description: "Where to put the DDT Quest button. It falls back to floating on its own if Discord's toolbar cannot be found.",
        options: [
    ...
    questButtonAction: {
        ...
        options: [
            { label: "Open the DDT Quest panel", value: "panel", default: true },
