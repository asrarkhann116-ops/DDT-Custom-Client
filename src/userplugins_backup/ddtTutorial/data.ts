...
export const TUTORIAL_SEEN_KEY = "DDTTutorial_seen_v1";
export const TUTORIAL_LANGUAGE_KEY = "DDTTutorial_language";
...
export const UI_COPY = {
    en: {
        ...
        english: "English",
        italian: "Italiano",
        reopenHint: "You can reopen this tutorial from the DDTTutorial settings.",
    ...
    it: {
        ...
        english: "English",
        italian: "Italiano",
        reopenHint: "Puoi riaprire questo tutorial dalle impostazioni di DDTTutorial.",
...
export const TUTORIAL_STEPS: TutorialStep[] = [
    ...
    },
    {
        ...
        route: {
            en: "Settings > DDT Settings",
            it: "Settings > DDT Settings"
        },
        body: {
            en: "The DDT section is the control room for the client. Start there when you want to change behavior or find a tool.",
            it: "La sezione DDT è la sala comandi del client. Parti da lì quando vuoi cambiare comportamento o trovare uno strumento."
        },
        bullets: {
            en: [
                "DDT contains general client settings.",
                "Plugins lists Vencord, DDT, DDT, and user plugins.",
                "Themes, Updater, Changelog, and Backup each have their own page."
            ],
            it: [
                "DDT contiene le impostazioni generali del client.",
                "Plugins mostra i plugin Vencord, DDT, DDT e quelli dell'utente.",
                "Themes, Updater, Changelog e Backup hanno pagine dedicate."
            ]
        },
        panel: "DDT_main_panel",
        actionLabel: {
            en: "Open DDT",
            it: "Apri DDT"
        }
    },
    {
        ...
        route: {
            en: "Settings > DDT Settings > Plugins",
            it: "Settings > DDT Settings > Plugins"
        },
        body: {
    ...
    },
    {
        ...
        body: {
            en: "If DDT lags, freezes, or starts using too much memory, open Client Diagnostics before disabling random plugins.",
            it: "Se DDT lagga, si blocca, o usa troppa memoria, apri Client Diagnostics prima di disattivare plugin a caso."
        },
        bullets: {
            en: [
        ...
        panel: "DDT_client_diagnostics_panel",
        actionLabel: {
            en: "Open Diagnostics",
            it: "Apri Diagnostics"
        }
    },
    {
        ...
        route: {
            en: "Settings > DDT Settings > Themes",
            it: "Settings > DDT Settings > Themes"
        },
        body: {
    ...
    },
    {
        ...
        route: {
            en: "Settings > DDT Tools",
            it: "Settings > Strumenti DDT"
        },
        body: {
            en: "DDT tools are local advanced workflows such as Presence Lab, Mutual Scanner, and Send Trail.",
            it: "Gli strumenti DDT sono workflow avanzati locali come Presence Lab, Mutual Scanner e Send Trail."
        },
        bullets: {
            en: [
    ...
    },
    {
        ...
        panel: "DDT_stereo_installer_panel",
        actionLabel: {
    ...
    },
    {
        ...
        route: {
            en: "Settings > DDT Settings > Updater",
            it: "Settings > DDT Settings > Updater"
        },
        body: {
            en: "Updater checks for DDT updates. Use it when a patch breaks, the client crashes, or you want the newest fixes.",
            it: "Updater controlla gli aggiornamenti di DDT. Usalo quando una patch si rompe, il client crasha, o vuoi gli ultimi fix."
        },
        bullets: {
            en: [
    ...
    },
    {
        ...
        route: {
            en: "Settings > DDT Settings > Changelog",
            it: "Settings > DDT Settings > Changelog"
        },
        body: {
    ...
    },
    {
        ...
        route: {
            en: "Settings > DDT Settings > Backup & Restore",
            it: "Settings > DDT Settings > Backup & Restore"
        },
        body: {
        ...
        panel: "DDT_backup_restore_panel",
        actionLabel: {
            en: "Open Backup",
            it: "Apri Backup"
        }
