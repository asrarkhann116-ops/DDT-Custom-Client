...
export const settings = definePluginSettings({
    format: {
        ...
        default: "{DDTIcon} DDT {DDTVersion} ({DDTHash})",
        restartNeeded: true
    }
});
...
export const settingVariables = [
    ...
    "DDT Variables:",
    "{DDTIcon} - DDT icon",
    "{DDTVersion} - Version of DDT (e.g. 1.0.0)",
    "{DDTHash} - DDT build hash (e.g. 123456789)",
    "{DDTPlatform} - Platform DDT is running on (e.g. Dev Build)",
    "",
