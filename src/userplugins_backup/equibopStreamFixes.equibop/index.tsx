...
export default definePlugin({
    name: "DDTStreamFixes",
    description: "Tries to fix stream quality on DDT by patching Discord's encoder and quality restrictions.",
    tags: ["Voice"],
    ...
    getStreamConfig() {
        ...
        try {
            const state = JSON.parse(localStorage.getItem("DDTState") ?? "{}");
