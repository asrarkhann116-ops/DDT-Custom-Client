...
import { providers } from "@userplugins/musicControls/spotify/lyrics/api";
import { lyricsAlternative } from "@userplugins/musicControls/spotify/lyrics/providers/store";
