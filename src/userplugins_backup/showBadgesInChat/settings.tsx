...
const settings = definePluginSettings({
    showDDTDonor: {
        ...
        description: "Enable to show DDT Donor badges in chat.",
        hidden: true,
        default: true
    },
    DDTDonorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the DDT Donor badges.",
        hidden: true,
        default: 0
    },
    showDDTContributor: {
        type: OptionType.BOOLEAN,
        description: "Enable to show DDT Contributor badges in chat.",
        hidden: true,
        default: true
    },
    DDTContributorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the DDT Contributor badge.",
        hidden: true,
        default: 1
    },
    showVencordDonor: {
...
const BadgeSettings = () => {
    const [images, setImages] = useState([
        { src: "https://badge.DDT.org/donor.webp", shown: settings.store.showDDTDonor, title: "DDT donor badges", key: "DDTDonor", position: settings.store.DDTDonorPosition },
        { src: "https://DDT.org/assets/favicon.png", shown: settings.store.showDDTContributor, title: "DDT contributor badge", key: "DDTContributer", position: settings.store.DDTContributorPosition },
    ...
    useEffect(() => {
        images.forEach(image => {
            switch (image.key) {
                case "DDTDonor":
                    settings.store.DDTDonorPosition = image.position;
                    settings.store.showDDTDonor = image.shown;
                    break;
                case "DDTContributer":
                    settings.store.DDTContributorPosition = image.position;
                    settings.store.showDDTContributor = image.shown;
                    break;
                case "VencordDonor":
