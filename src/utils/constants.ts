 ...
 */
export const Devs: Record<string, any> = /* #__PURE__*/ Object.freeze({
    Ven: {
        name: "V",
...
export const DDTDevs = Devs;
export const GUILD_IDS = Object.assign([VENCORD_GUILD_ID], {
    VENCORD: VENCORD_GUILD_ID,
}) as unknown as string[] & Record<string, string>;
export const GUILD_ID = VENCORD_GUILD_ID;
export const EQUIBOT_USER_ID = VENBOT_USER_ID;
export const SUPPORT_CHANNEL_IDS = [SUPPORT_CHANNEL_ID];
export const VC_SUPPORT_CHANNEL_IDS = [SUPPORT_CHANNEL_ID];
