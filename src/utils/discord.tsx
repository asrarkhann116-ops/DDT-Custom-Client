...
export function openPrivateChannel(userId: string, ...args: any[]) {
    return ChannelActionCreators.openPrivateChannel(userId, ...args);
}
 ...
 */
export async function fetchUserProfile(id: string, options?: FetchUserProfileOptions, skipCache = false) {
    if (!skipCache) {
