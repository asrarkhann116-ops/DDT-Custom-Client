...
export const isDDTPluginDev = isPluginDev;
export const isAnyPluginDev = isPluginDev;
export function getUserAvatarUrl(user: any, ...args: any[]): string {
    return user?.getAvatarURL?.(...args) ?? "";
}
export function isDDTGuild(...args: any[]): boolean {
    return false;
}
export function isDDTSupport(...args: any[]): boolean {
    return false;
}
